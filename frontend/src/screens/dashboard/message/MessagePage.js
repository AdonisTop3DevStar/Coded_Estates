          ...
          (
            <Col md={3} className="border-end content-detail">
              ...
              <div className="border-top py-2">
                ...
                <div className="fw-bold mb-1">0x20jsd...90b ent a offer</div>
              ...
              <div className="border-top py-1">
                ...
                <div className="text-gray pb-2 border-bottom"><small>020jsd...90b</small></div>
            ...
            <Col md={3} className="border-end content-detail">
              ...
              <div className="border-top py-2">
                ...
                <div className="fw-bold mb-1">You sent an offer to 0x20jsd...90b</div>
              ...
              <div className="border-top py-2">
                ...
                <div className="text-gray pb-2 border-bottom"><small>0x20jsd...90b</small></div>
